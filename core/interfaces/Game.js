 ...
 * @property {Object.<string, Player>} players - Map of playerId to Player objects (read-only)
 * @property {Function} endGame - Function to end the current game
